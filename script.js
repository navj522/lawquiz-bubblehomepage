// YASIR BHOI COMMENTS SAHI SE PAD NA AGAR MODIFICATION KARNA HO TO. ye wala part Initializes the current question index, score, high scores from local storage, quiz data, user name and selected option
...
// Yasir bhoi mera ek confession hai... maine replay button ke liye CHATGPT ki help li thi but it works flawlessly soooo.Function to start a new quiz by resetting the relevant variables and hiding the score container
const replayQuiz = () => {
  currentQuestion = 0;
  score = 0;
...
// Add event listener for the Replay Quiz button
